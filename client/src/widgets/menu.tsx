...
export type TMode = 'login' | 'menu' | 'counters' | 'users'

type TMunuProps = { user: TUser; modeChange: (mode: TMode) => void }

export default function MainMenu({ user, modeChange }: TMunuProps) {
  const handleLogout = () => {
